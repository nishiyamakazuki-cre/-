...
<title>メイン画面</title>
<link rel="stylesheet"
	href="http://localhost:8080/hamujiro/css/main.css">
</head>
<body>
	...
	<div class="wrap2" id="fadeElement">
		<audio id="ex" loop>
			<source src="http://localhost:8080/hamujiro/bgm/tv_noise2.mp3"
				type="audio/mpeg">
		</audio>
		<div class="container">
			...
			<ul class="gnav">
				<li><a href="#">おせわ&nbsp;&nbsp;&nbsp;</a>
					<ul>
						...
						<li><a href="#" data-action="touch">なでなで</a></li>
					</ul></li>
				<li><a href="#">おでかけ</a>
					<ul>
		...
		<div class="parameter">
			<p>
				...
				<%=ham.getWater()%><br> <br>
				<%
				if (chr.getMoney() < 10000) {
				%>
				所持金&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
				<%
				} else if (chr.getMoney() < 100000) {
				%>
				所持金&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
				<%
				} else {
	...
	<div class=audio>
		<audio id="bgm" autoplay loop>
			<source src="http://localhost:8080/hamujiro/bgm/今日はお散歩日和。.mp3"
				type="audio/mpeg">
			<p>サイトの設定で音楽が流れません。</p>
		</audio>
	</div>

...
// 全アイテムのリスト（仮想データ）
List<itemBOX> items = (List<itemBOX>) request.getAttribute("itemList");
List<itemBOX> list = new ArrayList<itemBOX>();
list.clear();
...
<link rel="stylesheet"
	href="http://localhost:8080/hamujiro/css/shop.css">
</head>
<body>
		...
		<div class="item">
			...
			<p>
				<a
					...
					<%=pageItems.get(i).getName()%></a> &nbsp;:&nbsp;<%=pageItems.get(i).getItem_val()%>
				円
			</p>
			<%
			}
